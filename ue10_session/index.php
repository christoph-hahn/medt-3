<?php
	...
	{
		header('Location: http://localhost:83/medt/ue10_session/project-list.php');
	}	
?>
...
<body class="container">
	...
	<h1>Herzlich Willkommen auf der Seite!</h1> <br>
...
<?php
	if (isset($_POST['submitBtn']) && $_POST['bn'] == 'chrisi' && $_POST['pw'] == 'chrisi')
	{
		session_start();
		$_SESSION['check'] = true;
		header('Location: http://localhost:83/medt/ue10_session/project-list.php');
